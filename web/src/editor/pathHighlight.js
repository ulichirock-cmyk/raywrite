...
const PATH_RE = new RegExp(
  [
    ...
    String.raw`(?<![\w./\\])[\w\-]+(?:\.[\w\-]+)*\.(?:c|h|cpp|hpp|cc|cxx|m|mm|js|mjs|cjs|ts|jsx|tsx|py|vue|rs|go|java|kt|swift|css|scss|less|html|htm|json|yaml|yml|toml|ini|md|txt|sh|fish|bash|zsh|sql|proto|cmake|mk|log)(?::\d+)?(?![\w.])`,
  ].join('|'),
  'g'
)
